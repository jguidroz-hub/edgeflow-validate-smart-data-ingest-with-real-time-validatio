...
const FROM = process.env.EMAIL_FROM || 'EdgeFlow Validate - Smart data ingest with real-time validation to S3 <noreply@example.com>';
const APP_NAME = 'EdgeFlow Validate - Smart data ingest with real-time validation to S3';
