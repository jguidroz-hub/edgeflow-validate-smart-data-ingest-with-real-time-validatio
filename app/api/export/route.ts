  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="EdgeFlow Validate - Smart data ingest with real-time validation to S3-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
