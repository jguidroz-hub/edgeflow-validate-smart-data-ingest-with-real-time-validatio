...
export default function FeaturePage() {
  const items = [
    { t: "Ingestion Pipeline", d: "Throughput: 12K events/min • Latency: 45ms • Status: Healthy", s: "healthy" },
    { t: "Transform Stage", d: "Processing: 8.5K events/min • Queue depth: 234 • Status: Healthy", s: "healthy" },
    { t: "Load Stage", d: "Write rate: 6K rows/min • Failed: 12 (0.02%) • Status: Warning", s: "warning" },
    { t: "Dead Letter Queue", d: "45 items • Oldest: 2 hours • Needs review", s: "action" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b px-6 py-3 flex items-center gap-4">
        ...
        <h1 className="font-bold">Pipeline Monitor</h1>
      </header>
      <div className="max-w-4xl mx-auto px-6 py-8">
        <p className="text-gray-500 text-sm mb-6">Real-time data pipeline health</p>
